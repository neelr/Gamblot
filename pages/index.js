...
const Index = ()=> {
  return(
    <Layout>
      ...
      <iframe src="https://airtable.com/embed/shrsOsFBwZoUfbDGv?backgroundColor=gray" width="100%" height="533" style={{backgroundColor:"transparent", border:"1px solid #ccc"}}></iframe>
    </Layout>
  )
}
